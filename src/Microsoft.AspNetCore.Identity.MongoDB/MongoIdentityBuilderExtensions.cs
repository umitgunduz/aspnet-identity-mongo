...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class MongoIdentityBuilderExtensions
    {
        ...
        /// <param name="url">Must contain the database name</param>
        /// <param name="mongoClientSettings"></param>
        public static IdentityBuilder RegisterMongoStores<TUser, TRole>(this IdentityBuilder builder, MongoUrl url, MongoClientSettings mongoClientSettings)
            ...
            where TUser : IdentityUser
        {
            ...
            return RegisterMongoStores<TUser, TRole>(builder, url, clientSettings);
        }
		...
		/// </summary>
		/// <param name="services"></param>
		/// <param name="url">Connection string must contain the database name</param>
        /// <param name="mongoClientSettings"></param>
		public static IdentityBuilder AddIdentityWithMongoStores(this IServiceCollection services, MongoUrl url, MongoClientSettings mongoClientSettings)
        {
            return services.AddIdentityWithMongoStoresUsingCustomTypes<IdentityUser, IdentityRole>(url, mongoClientSettings);
        }
        ...
        /// <param name="url">Connection string must contain the database name</param>
        /// <param name="mongoClientSettings"></param>
        public static IdentityBuilder AddIdentityWithMongoStoresUsingCustomTypes<TUser, TRole>(this IServiceCollection services, MongoUrl url, MongoClientSettings mongoClientSettings)
            where TUser : IdentityUser
            where TRole : IdentityRole
        {
            return services.AddIdentity<TUser, TRole>()
                .RegisterMongoStores<TUser, TRole>(url, mongoClientSettings);
        }
    }
}